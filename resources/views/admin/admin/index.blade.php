...
@section('content')
    ...
    <div class="page-content fade-in-up">
        <div class="ibox">
            <div class="ibox-head">
                <div class="ibox-title">List Data Admin</div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="#" id="form-devisi" method="post">
                        ...
                        {{-- Tombol untuk action submit dan cancel --}}
    ...
    <script type="text/javascript">
        ...
        $("#form-devisi").submit(function(e) {
            ...
            $.ajax({
                ...
                processData: false,
                dataType: 'json',
                // Handle respon jika berhasil simpan
